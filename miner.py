...
class Miner:
    ...
    def mine(self, last_hash, sha_signature, random_wait):
        #Makes the miner sleep a random amount of time to simulate the fact that different miners
        #Will have GPU's which have more or less mining power
        #So, if random wait is a big number, that means the GPU is slow
